...
import {Row, Col, Card, CardHeader, Button, Progress,CardBody} from 'reactstrap'
import Chart from 'react-apexcharts';
    export function DashbordChart() {
                                ...
                                <CardHeader>
                                    ...
                                    <div className="card-header--actions">
                                        ...
                                        <span className="btn-wrapper--label">
                                            ...
                                            {/* <FontAwesomeIcon icon={['fas', 'chevron-down']} className="opacity-8 font-size-xs" /> */}
                                        </span>
                                        </Button>
                                    </div>
                                </CardHeader>
                                        ...
                                        <Col sm="6" md="7">
                                            ...
                                            <div className="pb-4 px-3">
                                                ...
                                                <span className="d-flex align-items-center font-size-lg d-block">
                                                    <Progress value="65" striped animated color="warning" className="progress-sm flex-grow-1 progress-bar-rounded" />
                                                    <span className="pl-3">65%</span>
                                                </span>
                                            </div>
                                        </Col>
                                    </Row>
                                    <Chart options={chartDashboardStatistics2AOptions} series={chartDashboardStatistics2AData} type="area" height={317} />
                                </div>
                            </Card>
                        </Col>
                        <Col xl="6">
                            <Card className="card-box mb-5">
                                ...
                                <CardBody>
                                    <Chart options={chartDashboardStatistics2BOptions} series={chartDashboardStatistics2BData} type="bar" height={280} />
                                    <Row>
                                        <Col md="6">
                                            <div className="p-3">
                                                <div className="mb-1 font-weight-bold">Orders</div>
                                                <Progress animated className="progress-xs progress-animated-alt" color="primary" value="34" />
                                        ...
                                        <Col md="6">
                                            <div className="p-3">
                                                ...
                                                <Progress animated className="progress-xs progress-animated-alt" color="success" value="51" />
                                                <div className="align-box-row progress-bar--label mt-1 text-muted">
                                                    <small className="text-dark">0</small>
                                                    <div className="ml-auto">100%</div>
                                                </div>
                                        ...
                                        <Col md="6">
                                            <div className="p-3">
                                                ...
                                                <Progress animated className="progress-xs progress-animated-alt" color="warning" value="29" />
                                                <div className="align-box-row progress-bar--label mt-1 text-muted">
                                                    <small className="text-dark">0</small>
                                                    <div className="ml-auto">100%</div>
                                                </div>
                                        ...
                                        <Col md="6">
                                            <div className="p-3">
                                                ...
                                                <Progress animated className="progress-xs progress-animated-alt" color="danger" value="76" />
                                                <div className="align-box-row progress-bar--label mt-1 text-muted">
                                                    <small className="text-dark">0</small>
                                                    <div className="ml-auto">100%</div>
                                                </div>
